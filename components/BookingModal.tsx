...
const services = {
  ...
  cardio: {
    ...
    unit: "person/session",
    description:
      "Fun like fitness tennis session."
  },
  consultation: {
    name: "Consultation",
    price: 150,
        ...
        <AnimatePresence mode="wait">
          {step === "payment" && (
            ...
            >
                ...
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3 mb-4">
                    <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center">
                      <p className="h-8 w-8 text-center text-green-600">{service.icon}</p>
                    </div>
                    <div>
              ...
              <Card>
                <CardContent className="p-4">
                  <h4 className="font-semibold text-gray-900 mb-4 flex ice">
                  ...
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                    <p className="text-sm text-blue-800">
                      ...
                      number in your transfer description for faster processing.
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          {step === "confirmation" && (
            ...
            >
              ...
              <div className="space-y-3">
                <Button onClick={handleShareReceipt} className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold" size="lg">
                  <IoMdMail className="mr-2 h-4 w-4" />
                  Share Receipt via Email
                </Button>

                <p className="text-xs text-gray-500">
                  This will open your email app with a pre-filled message to acestennis@yahoo.com
                </p>
              </div>
            </motion.div>
          )}
